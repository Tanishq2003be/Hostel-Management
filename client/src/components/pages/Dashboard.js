...
const att=require("../../img/att.jpeg");
    ...
    return (
      <div className="mid container">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '2rem' }}>
          ...
          <div className="card hoverable" style={{ width: "18rem", hover: '', height: '22rem',margin:'1rem' }}>
          ...
          <div className="card" style={{ width: "18rem", hover: '', height: '22rem',margin:'1rem' }}>
